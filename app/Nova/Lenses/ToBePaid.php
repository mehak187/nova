...
class ToBePaid extends Lens
{
    public $name = 'Paiement en attente';
    ...
    public static function query(LensRequest $request, $query)
    {
        return $request->withOrdering($request->withFilters(
            $query->whereIn('status', ['finished', 'cancelled'])->whereNull('paid_at')->orderBy('started_at', 'desc')
        ));
    }
