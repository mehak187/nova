                ...
                <form action="/register" method="POST">
                    ...
                    <div class="flex -mx-2">
                        <div class="flex-1 px-2 mb-4">
                            ...
                            <input type="text" name="first_name" id="first_name" class="px-4 py-2 block w-full border rounded" value="{{ old('first_name') }}" />
                        ...
                        <div class="flex-1 px-2 mb-4">
                            ...
                            <input type="text" name="last_name" id="last_name" class="px-4 py-2 block w-full border rounded" value="{{ old('last_name') }}" />
                    ...
                    <div class="mb-4">
                        <label for="mobile_phone" class="block text-xs font-bold text-gray-600 uppercase">N° téléphone mobile</label>

                        <input type="tel" name="mobile_phone" id="mobile_phone" class="px-4 py-2 block w-full border rounded" value="{{ old('mobile_phone') }}" />
                    ...
                    {{-- <div class="mb-4">
                        <label for="phone" class="block text-xs font-bold text-gray-600 uppercase">Téléphone</label>

                        <input type="text" name="phone" id="phone" class="px-4 py-2 block w-full border rounded" value="{{ old('phone') }}" />
